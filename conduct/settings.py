"""
Django settings for conduct project.
...
SECRET_KEY = 'sok$-u^0+@@_)8_3jkq(uohmqbsj-#hg0idc&5zi6$!l1+v#8+'
...
WSGI_APPLICATION = 'conduct.wsgi.application'
